...
<body>
  ...
  <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
      ...
      <div class="alert alert-danger" role="alert" id="lblvacio">
      ...
      <button type="button" class="btn btn-info btn-block" id="btnlogin">Iniciar Sesion</button> <!--ESE ID ES para llamarlo EN EL js--->
...
<!---firebase  <script src="https://cdnjs.cloudflare.com/ajax/libs/firebase/9.17.1/firebase-auth.min.js" integrity="sha512-cVdea5/hhzAHj9vk1DPP5AtvrqPbw55MuaMJm2ROhWBvyqpBbPdQ1nN+FGK8bbb6K/+QakZaRC1CLDHjkkbl6A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>-->

<script src="https://www.gstatic.com/firebasejs/8.3.1/firebase-app.js"></script>
  <script src="https://www.gstatic.com/firebasejs/8.3.1/firebase-analytics.js"></script>
  <script src="https://www.gstatic.com/firebasejs/8.3.1/firebase-auth.js"></script>

  <script src="index.js"></script> <!----llamamos al JS-->
